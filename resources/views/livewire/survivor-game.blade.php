                            ...
                            <div class="flex justify-evenly py-3 items-center">
                                ...
                                <div class="col">
                                    ...
                                    <div class="bg-blue-500 rounded-xl opacity-80 px-2 mx-auto text-center p-2 text-lg">
                                        <span class="flex font-bold text-green-500 drop-shadow-lg">{{ $playerCount['Alive'] }} Alive <span class="inline font-bold text-white">&nbsp;|&nbsp;<span class="font-bold drop-shadow-lg inline text-error">{{ $playerCount['Dead'] }} Dead</span></span></span>
                                    </div>
                                </div>
                            </div>
